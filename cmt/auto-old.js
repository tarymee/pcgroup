...
(function (window,document) {
	...
	var AllCommentNS = {
		...
		cssLink: "http://192.168.50.53/kuaipan/pcgroup/20160122pcautocmt/auto-old.css",//样式地址
		pageNo: 1,//初始化评论信息页数
		index: 0,//评论条数计数
		pageSize: 6,//每页几条评论
	...
	//初始化html
	var Jcmt = $$("Jcmt");
	var cmtHtml = ['<div class="m-cmt-section"><span class="m-cmt-section-mark">所有评论</span></div>',
	...
	'	<a class="m-cmt-tf-num" id="JcmtCount" style="display:none;"></a>',
